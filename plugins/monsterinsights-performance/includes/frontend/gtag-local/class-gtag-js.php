...
final class MonsterInsights_Gtag_Local_Js {
    ...
    public function __construct() {
        ...
        add_action( 'monsterinsights_fetch_remote_gtag_js', array( $this, 'monsterinsights_get_remote_gtag_js_content' ) );
        ...
        add_action( 'wp_ajax_monsterinsights_vue_get_local_gtag_js_from_remote', array( $this, 'get_local_gtag_js_from_remote' ) );
    }
