...
class __TwigTemplate_cf24a914dd28fccaadfe2e1cb07f03bbf19744c064817ac5dbff12551f11bcce extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "newsletter/templates/blocks/social/settings.hbs", "/opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/mailpoet/views/newsletter/templates/blocks/social/settings.hbs");
    }
}
